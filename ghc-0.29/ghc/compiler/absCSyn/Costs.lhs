% Time-stamp: <Sun Mar 24 1996 03:14:03 Stardate: [-31]7245.67 hwloidl>
%
% (c) The GRASP/AQUA Project, Glasgow University, 1994-1996
%     Hans Wolfgang Loidl
%
% This module is only needed in a GranSim setup ("stubs" are defined in a
% non GranSim setup).
% ---------------------------------------------------------------------------
...
stmtMacroCosts macro modes =
  ...
  case macro of
    ...
    GRAN_YIELD   		->  nullCosts     {- GrAnSim bookkeeping -}
